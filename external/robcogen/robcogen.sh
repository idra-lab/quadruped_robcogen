...
java --add-opens java.base/java.lang=ALL-UNNAMED -Dlog4j.configuration=file:${ROBCOGEN_DIR}/log4j.cfg -classpath ${CLASSPATH}:${ROBCOGEN_DIR}/bin/ iit/robcogen/Generator $1 $2 $3
